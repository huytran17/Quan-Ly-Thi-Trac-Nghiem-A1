...
if (isset($_GET['editrule'])) {
    if ($quydinh = $qd->getById($_GET['editrule'])->fetch_assoc()) extract($quydinh);
}
...
if (isset($_POST['submit'])) {
    ...
    if (!$hasError) {
        $affected_rows = $qd->update($editrule, [
...
<div class="edit_profile">
    <form action="" method="post" enctype="multipart/form-data">
        <div class="form-row">
            <h1 class="form-title">Chỉnh sửa thông tin quy định</h1>
        </div>
        <div class="form-row">
