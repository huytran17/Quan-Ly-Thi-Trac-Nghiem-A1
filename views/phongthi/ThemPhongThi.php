    ...
    <div class="form-row">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="date" name="ngaythi" class="form-control" value="<?php echo isset($ngaythi) ? $ngaythi : '' ?>" required />
            </div>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="date" name="thoigianbatdau" class="form-control" value="<?php echo isset($thoigianbatdau) ? $thoigianbatdau : '' ?>" required />
            </div>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="date" name="thoigianketthuc" class="form-control" value="<?php echo isset($thoigianketthuc) ? $thoigianketthuc : '' ?>" required />
            </div>
